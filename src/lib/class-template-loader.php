 ...
 */
namespace Site_Functionality\Lib;
...
class Template_Loader {
	 ...
	 * @var string
	 */
	protected $theme_template_directory = 'template-parts/blocks';
	 ...
	 * @var string
	 */
	protected $plugin_directory = SITE_FUNCTIONALITY_PATH;
	 ...
	 * @var string
	 */
		protected $plugin_template_directory = 'src/app/templates/frontend';
